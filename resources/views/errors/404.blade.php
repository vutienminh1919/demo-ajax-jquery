...
<div class="error">
    ...
    {{--    <button class="error__button error__button--active"><a href="{{route('admin.login')}}">Login</a></button>--}}
    {{--    <button class="error__button"><a href="{{route('products.index')}}">Back</a></button>--}}
</div>
