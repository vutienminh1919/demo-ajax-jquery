            ...
            <div class="col-sm-12">
                ...
                <form class="md-float-material form-material" method="post">
                    ...
                    <div class="text-center">
                        <h2>WELCOME <i class="fab fa-accessible-icon"></i></h2>
                    </div>
                    <div class="auth-box card">
                        <div class="card-block">
                            <div class="row m-b-20">
                                <div class="col-md-12">
                                    <h3 class="text-center txt-primary"><i class="fas fa-lock-open"></i> Sign In</h3>
                                </div>
                            </div>
                            <div class="row m-b-20">
                                <div class="col-md-6">
                                    <a  href="{{ url('/auth/redirect/google') }}" class="btn btn-danger m-b-20 btn-block">Google
                                        <i class="fab fa-google fa-fw"></i>
                                    </a>

                                </div>
                                <div class="col-md-6">
                                    <a href="{{ url('/auth/redirect/github') }}" class="btn btn-dark m-b-20 btn-block">Github
                            ...
                            <p>Don't have an account?<a href="{{route('admin.showFormRegister')}}"> <b>Register here </b></a>
                        </div>
                    </div>
                </form>
                <!-- end of form -->
